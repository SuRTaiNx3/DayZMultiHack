...
namespace UtilsLibrary.PE
{
    ...
    public struct PEInfo
    {
        ...
        {
            ProcessMemory memUtils = new ProcessMemory();
        ...
        /// <returns></returns>
        public static PEInfo FromMemory(ProcessModule module, ProcessMemory memUtils)
        {
        ...
        /// <param name="memUtils">MemUtils-instance that is used to dump the module</param>
        /// <returns></returns>
        public static PEInfo FromMemory(IntPtr baseAddress, int length, ProcessMemory memUtils)
        {
        ...
        /// <returns></returns>
        public _IMAGE_EXPORT_DIRECTORY ReadImageExportDirectory(ProcessMemory memUtils, IntPtr imageBase)
        {
        ...
        /// <param name="imageBase">Base-address pf this module in memory</param>
        /// <returns></returns>
        public string ReadName(ProcessMemory memUtils, _IMAGE_EXPORT_DIRECTORY ied, IntPtr imageBase)
        {
        ...
        /// <param name="imageBase">Base-address pf this module in memory</param>
        /// <returns></returns>
        public Tuple<string, int>[] ReadExportedFunctions(ProcessMemory memUtils, IntPtr imageBase)
        {
        ...
        /// <param name="ied">The _IMAGE_EXPORT_DIRECTORY of this module</param>
        /// <returns></returns>
        public Tuple<string, int>[] ReadExportedFunctions(ProcessMemory memUtils, IntPtr imageBase, _IMAGE_EXPORT_DIRECTORY ied)
        {
